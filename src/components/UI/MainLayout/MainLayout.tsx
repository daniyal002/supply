...
const MainLayout = ({
  ...
  const latestNews = `🔥 Теперь в заявке можно увидеть количество выданного товара из склада; 🔥 Через кнопку «Помощь» доступны видеоинструкции по работе с программой; 🔥 В профиле можно менять пароль`;
